...
var itemarray = []; var Customergroupid = []; var Itemgroupid = []; var commongropid = ''; var taxstate = ''; var columncount = 0;
var newcolumncount = '';var coljson = '';var Componentjson = '';var TotalSumTaxwithtax = 0;var LoadData = ''; var dblClickInvoiceId 
var imagearray=[]; var GlobalJson=''; var Taxexclusiveinclusive=''; var discountValue=0;var discountMode=0; var fromqty=0;var toqty=0; var SumOfDiscountRs=0;var SumOfDiscountPercent=0;
 ...
 $(document).on("dblclick","#saleInvoicetbl tbody tr",function() {
   var row = jquery_1_11_3_min_p(this);
    ...
    jquery_1_11_3_min_p("#btnDeleteLine").click(function () {
        ...
        jquery_1_11_3_min_p('#lblRsdiscount').text(0.00);
        jquery_1_11_3_min_p('#lblPercentdiscount').text(0.00);
...
} /// <reference path="../WebServices/Saleinvoice.asmx" />


function BindPartners(EntityId) {
   Partners = []; 
    jquery_1_11_3_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "../WebServices/Saleinvoice.asmx/BindPartners",
        ...
        success: function (result) {
            ...
            Partners.push({ value: "0", text: "Select" });
            jQuery.each(jsonData.Table, function (rec) {
                Partners.push({ value: jsonData.Table[i].partnerId, text: jsonData.Table[i].partnername });
                i++;
            });
...
function BindLegaltax(PartnerId,Locationid) {
    jquery_1_11_3_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "../WebServices/Saleinvoice.asmx/BindLegaltax",
        ...
        success: function (result) {
            ...
            jQuery.each(jsonData.Table, function (rec) {
                ...
                markup = "<div class='col-md-6'><label class='AddressLabel'>" + jsonData.Table[i].FieldName + "</label><label class='AddressValue'>: " + jsonData.Table[i].TaxPercent + "</label></div>";
...
function BindPartnerAddress(PartnerId) {
    PartnerAddress = [];
    var EntityId = kendo_all_min_js('#ddlentity').data("kendoDropDownList").value();
    ...
    jquery_1_11_3_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "../WebServices/Saleinvoice.asmx/BindPartnerAddress",
...
//    }
    ...
    jquery_1_11_3_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "../WebServices/Saleinvoice.asmx/BindItem",
...
//                        itemarray.push(kendo_all_min_js('#' + id).data("kendoDropDownList").value());
    ...
    function Binddataquantity(Data) {
        ...
        var disper='lblDiscountPercent_'+data[1];
         var item= kendo_all_min_js('#' + newid).data("kendoDropDownList").value();
            GetDiscount(item);
        sumofquantity = 0; sumofunitprice = 0;lineamountwithouttax = 0;SumOfDiscountPercent=0;SumOfDiscountRs=0;
        ...
        jquery_1_11_3_min_p('#tblsaleInvoiceFields tbody').find('tr').each(function () {
            ...
            //added by satyendar for discount sum
           
             var rowid = "lbldiscountRs_" + row.find("td:nth-child(" + newcolumncount + ")").text().trim();
            if (jquery_1_11_3_min_p('#' + rowid).text() == '') {
                SumOfDiscountRs = parseFloat(SumOfDiscountRs) + parseFloat(0.00);
            }
            else {
                SumOfDiscountRs = parseFloat(SumOfDiscountRs) + parseFloat(jquery_1_11_3_min_p('#' + rowid).text());
            }
              var rowid = "lblDiscountPercent_" + row.find("td:nth-child(" + newcolumncount + ")").text().trim();
            if (jquery_1_11_3_min_p('#' + rowid).text() == '') {
                SumOfDiscountPercent = parseFloat(SumOfDiscountPercent) + parseFloat(0.00);
            }
            else {
                SumOfDiscountPercent = parseFloat(SumOfDiscountPercent) + parseFloat(jquery_1_11_3_min_p('#' + rowid).text());
            }
        ...
        jquery_1_11_3_min_p('#lblRsdiscount').text(SumOfDiscountRs.toFixed(3));
        jquery_1_11_3_min_p('#lblPercentdiscount').text(SumOfDiscountPercent.toFixed(3));
    ...
    function Binddataunitprice(Data) {
        ...
        jquery_1_11_3_min_p('#' + id).removeClass('validate');
        sumofunitprice = 0; sumofquantity = 0; lineamountwithouttax = 0;SumOfDiscountRs=0;SumOfDiscountPercent=0;
        jquery_1_11_3_min_p('#tblsaleInvoiceFields tbody').find('tr').each(function () {
            var row = jquery_1_11_3_min_p(this);
...
jquery_1_11_3_min_p('#' + withouttaxid).text(parseFloat(jquery_1_11_3_min_p('#' + "txtQuantity_" + row.find("td:nth-child(" + newcolumncount + ")").text().trim()).val()) * withouttaxidNew);
    ...
    function BindTaxgroupvalue(Data,id) {
        ...
        if (jquery_1_11_3_min_p('#' + formullaid).text() !='') {
      ...
      //   ===========================================================get tax data value ==============================
            jquery_1_11_3_min_p.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../WebServices/Saleinvoice.asmx/Bindtaxstate",
                data: "{'Taxjson':" + Taxjson + ",'Taxdatajson':" + Taxdatajson + ", 'TaxState':'" + taxstate + "','Linevalue':'" + jquery_1_11_3_min_p('#' + formullaid).text() + "','Taxtype':'" + taxid + "','Taxgroupid':'" + groupid + "','Tempcols':'" + Temptaxstringifycol + "','TempDate':'" + jquery_1_11_3_min_p("#txtinvoicedate").val() + "','Tempinclusiveexclusive':'" + Taxexclusiveinclusive + "'}",
                dataType: "json",
                async: false,
                success: function (result) {
...
//            type: "POST",
//            contentType: "application/json; charset=utf-8",
//            url: "../WebServices/Saleinvoice.asmx/SaveInvoicedetails",
//            data: "{'InvoiceData':'" + InvoiceDatajson + "','Itemdata':'" + ItemdataJson + "'}",
//            dataType: "json",
//            async: false,
//            success: function (result) {
//                jsonData = eval(result.d);
...
//        });
    ...
    for (var i = 0; i < files.length; i++) {
      data.append(files[i].name, files[i]);
                ...
                jquery_1_11_3_min_p.ajax({
                    type: 'POST',
                    url: '../SaveInvoice.ashx?InVoiceNo='+jquery_1_11_3_min_p('#lblInvoiceNo').text()+'&Itemdata='+ItemdataJson+'&InvoiceData='+InvoiceDatajson+'&UserId='+CreatedBy,
                    processData: false,
                    contentType: false,
                    data: data,
                    async:false,
     ...
     function BindInvoiceNo() {
        ...
        jquery_1_11_3_min_p.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../WebServices/Saleinvoice.asmx/BindInvoiceNo",
            data: "{}",
            dataType: "json",
            async: false,
            success: function (result) {
 ...
 var SearchValue='';
    ...
    jquery_1_11_3_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "../WebServices/Saleinvoice.asmx/BindInvoiceGrid",
...
function BinddataOndblClick(InvoiceId)
{
        jquery_1_11_3_min_p.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../WebServices/Saleinvoice.asmx/BinddataOndblClick",
            data: "{'InvoiceId':'" + InvoiceId + "'}",
            dataType: "json",
            async: false,
            success: function (result) {
               var jsonData = eval(result.d);
                $("#lblPname").text(jsonData.Table[0].PartnerName);
                 $("#lblPCode").text(jsonData.Table[0].PartnerCode);
                $("#lblInvoiceNo").text(jsonData.Table[0].InvoiceNo);
                ...
                $("#txtduedate").val(jsonData.Table[0].Duedate)
                 ...
                 BindPartners(jsonData.Table[0].EntityId);
                 kendo_all_min_js('#ddlpartners').data("kendoDropDownList").value(jsonData.Table[0].PartnerId);
                 kendo_all_min_js('#ddlpartners').data("kendoDropDownList").readonly();
                 BindPartnerAddress(jsonData.Table[0].PartnerId)
                kendo_all_min_js('#ddlbillingaddress').data("kendoDropDownList").value(jsonData.Table[0].BillingLocId);
                 ...
                 $("#rdoappend input:radio").attr('disabled',true);
                  BindItem(jsonData.Table[0].PartnerId, kendo_all_min_js('#ddlbillingaddress').data("kendoDropDownList").value());
...
//                kendo_all_min_js('#' + "txtQuantity_" +RowCount).trigger("change");
                 if(Taxexclusiveinclusive==1)
                { 
                jquery_1_11_3_min_p('#' + "LineWithTax" +RowCount).val(jsonData.Table1[i].Quantity);
                 kendo_all_min_js('#' + "LineWithTax" +RowCount).trigger("change");
                }
                else
                {
                jquery_1_11_3_min_p('#' + "txtQuantity_" +RowCount).val(jsonData.Table1[i].Quantity);
            ...
            ////Ajax data post===========================================================================================
             jquery_1_11_3_min_p.ajax({
                ...
                success: function (result) {
                    ...
                    // jquery_1_11_3_min_p('#txtunitpricesum').text(newcardPriceWithDisc.toFixed(3));
                    }
                    else  if(discountMode==2)
                    {
                     var cartprice=TotalSumTaxwithouttax.toFixed(3);
                    ...
                    var finaltotalwithtax = 0;  var finaltotalwithouttax = 0; var unitpricesum=0; SumOfDiscountPercent=0;SumOfDiscountRs=0;
                     jquery_1_11_3_min_p('#tblsaleInvoiceFields tbody').find('tr').each(function () {
                        var row = jquery_1_11_3_min_p(this);
     ...
     function GetDiscount(ItemId) {
       ...
       var date=$("#txtinvoicedate").val();
        jquery_1_11_3_min_p.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../WebServices/Saleinvoice.asmx/GetDiscount",
