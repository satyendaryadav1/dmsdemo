...
namespace DealerManagementSystem
{
    ...
    /// </summary>
    //public class PurchaseInvoice : IHttpHandler
    public class PurchaseInvoice 
    {
        ...
        //    {
        //        string path = context.Server.MapPath("~/PurchaseInvoiceAttachment/" + InVoiceNo);
        //        string DbPath = "";
        ...
        //            DbPath = @"..\PurchaseInvoiceAttachment\" + InVoiceNo + @"\" + file.FileName;
        ...
        //    DataTable dt = CommonManger.FillDatatableWithParam("DMS_PurchaseInvoice", "@QueryType", "@Invoicedatajson", "@ItemDataJson", "@AttachFileJson", "@userId", "SaveInvoice", InvoiceData, Itemdata, AttachJson, UserId);
